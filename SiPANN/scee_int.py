...
class SimphonyWrapper(Model):
    ...
    def __init__(self, model, sigmas=dict()):
        ...
        if len(args[0]) != 1:
            raise ValueError("You have changing geometries, use in simphony doesn't make sense!")
    ...
    def regenerate_monte_carlo_parameters(self):
        ...
        Iterates through sigma dictionary to change each of those parameters, with
        the mean being the original values found in model.
        """
