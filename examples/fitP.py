...
# Value bounds
radiusMin        = 11.9;   radiusMax        = 12.1
couplerLengthMin = 4.48;   couplerLengthMax = 4.52
widthMin         = 0.45;   widthMax         = 0.55
thicknessMin     = 0.2; thicknessMax     = 0.24
gapMin           = 0.05; gapMax            = 0.3
angleMin         = 80; angleMax           = 90
couplerWidthMin  = 0.4; couplerWidthMax = 0.6
...
lowerBounds = [radiusMin,couplerLengthMin,widthMin,thicknessMin,couplerWidthMin,gapMin,angleMin]
upperBounds = [radiusMax,couplerLengthMax,widthMax,thicknessMax,couplerWidthMax,gapMax,angleMax]
